...
<?php if($redux_builder_amp['enable-single-social-icons-position'] == 2) { ?>
...
<?php } ?>
<?php if($redux_builder_amp['enable-single-social-icons-position'] == 1) { ?>
	.sticky_social{ width: 100%; top: 0; display: block; left: 0; box-shadow: 0px 4px 7px #000; background: #fff; padding: 7px 0px 0px 0px; position: fixed; margin: 0; z-index: 10; text-align: center; }
<?php } ?>
