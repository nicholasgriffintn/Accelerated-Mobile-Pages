...
function ampforwp_content_element_title() { ?>
...
function ampforwp_content_element_meta_info() { global $redux_builder_amp; ?>
...
function ampforwp_content_element_featured_image() { ?>
...
function ampforwp_content_element_content() { ?>
